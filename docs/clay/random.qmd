...
::: {.printedClojure}
```clojure
#object[org.apache.commons.math3.random.JDKRandomGenerator 0x486889c "org.apache.commons.math3.random.JDKRandomGenerator@486889c"]
...
::: {.sourceClojure}
```clojure
(r/rng :isaac) ;; => #object[org.apache.commons.math3.random.ISAACRandom 0x20cc047c "org.apache.commons.math3.random.ISAACRandom@20cc047c"]
(r/rng :isaac 5336) ;; => #object[org.apache.commons.math3.random.ISAACRandom 0x47b4d9bb "org.apache.commons.math3.random.ISAACRandom@47b4d9bb"]
(r/synced-rng (r/rng :isaac)) ;; => #object[org.apache.commons.math3.random.SynchronizedRandomGenerator 0x6cc7a8cf "org.apache.commons.math3.random.SynchronizedRandomGenerator@6cc7a8cf"]
```
:::
...
::: {.sourceClojure}
```clojure
(r/irandom my-prng) ;; => 749880657
(r/irandom my-prng 5) ;; => 1
(r/irandom my-prng 10 20) ;; => 16
(r/lrandom my-prng) ;; => 4168460114696887521
(r/lrandom my-prng 5) ;; => 3
(r/lrandom my-prng 10 20) ;; => 19
(r/frandom my-prng) ;; => 0.20633173
(r/frandom my-prng 2.5) ;; => 0.17484665
(r/frandom my-prng 10.1 10.11) ;; => 10.109573
(r/drandom my-prng) ;; => 0.8378862118810935
(r/drandom my-prng 2.5) ;; => 0.6278466158852086
(r/drandom my-prng 10.1 10.11) ;; => 10.109620107590043
(r/grandom my-prng) ;; => 0.14990515791384174
(r/grandom my-prng 20.0) ;; => -19.204553107277977
(r/grandom my-prng 10.0 20.0) ;; => 32.61845192927268
...
::: {.sourceClojure}
```clojure
(take 2 (r/->seq my-prng)) ;; => (0.6814642533279247 0.8061668830292861)
(r/->seq my-prng 2) ;; => (0.5539910494761073 0.8770152554927628)
(r/->seq my-prng 5 :antithetic) ;; => (0.5210227775296778 0.47897722247032215 0.47780310797147996 0.52219689202852 0.4732919711485142)
(r/->seq my-prng 5 :uniform) ;; => (0.10683996310025397 0.2118536163456408 0.5796011735542954 0.7574133417937569 0.9795305217248493)
(r/->seq my-prng 5 :systematic) ;; => (0.13198299486453166 0.33198299486453164 0.5319829948645317 0.7319829948645317 0.9319829948645317)
(r/->seq my-prng 5 :stratified) ;; => (0.04316733403928361 0.3816942049899091 0.4050494051118008 0.7173919040209813 0.8284595050238466)
```
:::
...
::: {.printedClojure}
```clojure
#object[org.apache.commons.math3.random.ISAACRandom 0x38948f2 "org.apache.commons.math3.random.ISAACRandom@38948f2"]
...
::: {.printedClojure}
```clojure
#object[org.apache.commons.math3.random.ISAACRandom 0x5689affd "org.apache.commons.math3.random.ISAACRandom@5689affd"]
...
r/default-rng ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x486889c "org.apache.commons.math3.random.JDKRandomGenerator@486889c"]
(r/set-seed) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x5e8d1324 "org.apache.commons.math3.random.JDKRandomGenerator@5e8d1324"]
(r/set-seed 9988) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0xa3f7fe1 "org.apache.commons.math3.random.JDKRandomGenerator@a3f7fe1"]
(r/set-seed!) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x486889c "org.apache.commons.math3.random.JDKRandomGenerator@486889c"]
(r/set-seed! 9988) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x486889c "org.apache.commons.math3.random.JDKRandomGenerator@486889c"]
```
:::
...
::: {.sourceClojure}
```clojure
(r/distribution :cauchy) ;; => #object[org.apache.commons.math3.distribution.CauchyDistribution 0x523c5dfe "org.apache.commons.math3.distribution.CauchyDistribution@523c5dfe"]
(r/distribution :cauchy {:median 2.0, :scale 2.0}) ;; => #object[org.apache.commons.math3.distribution.CauchyDistribution 0x4cfbfe48 "org.apache.commons.math3.distribution.CauchyDistribution@4cfbfe48"]
```
:::
...
::: {.sourceClojure}
```clojure
(r/drandom log-logistic) ;; => 3.7018389866325827
(r/frandom log-logistic) ;; => 2.8306856
(r/lrandom log-logistic) ;; => 6
(r/irandom log-logistic) ;; => 60
(r/sample log-logistic) ;; => 8.512875378855352
...
::: {.sourceClojure}
```clojure
(r/sample dirichlet) ;; => [0.0032038377707191245 0.605717680138081 0.39107848209119994]
...
(r/log-likelihood dirichlet (repeatedly 10 (fn* [] (r/sample dirichlet)))) ;; => 13.89223949678056
(r/observe dirichlet (repeatedly 10 (fn* [] (r/sample dirichlet)))) ;; => 15.02847118690109
(r/likelihood dirichlet (repeatedly 10 (fn* [] (r/sample dirichlet)))) ;; => 1348508.2797572948
...
::: {.sourceClojure}
```clojure
(r/sample weibull) ;; => 1.0114861938487278
(r/->seq weibull 3) ;; => (1.0022815331849562 0.9370854653996438 1.1684465270682418)
...
(r/set-seed! cauchy-mersenne-2288 2288) ;; => #object[org.apache.commons.math3.distribution.CauchyDistribution 0x3a036be2 "org.apache.commons.math3.distribution.CauchyDistribution@3a036be2"]
(vec (r/->seq cauchy-mersenne-2288 3)) ;; => [-0.1079136480774541 -5.558982159984645 -3.127061922456471]
```
:::
...
::: {.sourceClojure}
```clojure
(r/->seq r/default-normal 3) ;; => (2.0877914800655217 0.05703362896783526 -0.7336163378858906)
...
::: {.sourceClojure}
```clojure
(r/sample dirichlet3) ;; => [0.25176347768699486 0.22766107134889405 0.5205754509641112]
(r/sample dirichlet3) ;; => [0.5330136569993918 0.13935191486586274 0.3276344281347454]
...
::: {.sourceClojure}
```clojure
(r/sample multinomial) ;; => [11 23 28 44 44]
(r/sample multinomial) ;; => [12 17 29 37 55]
...
::: {.sourceClojure}
```clojure
(r/sample mixture-of-three) ;; => 1.102393590198155
(r/sample mixture-of-three) ;; => 0.8890040151295291
...
::: {.sourceClojure}
```clojure
(r/sample truncated-normal) ;; => -0.8640624998901583
(r/sample truncated-normal) ;; => -0.2814694963857404
...
::: {.sourceClojure}
```clojure
(r/sample kde-distr) ;; => 2.3217100350143935
(r/sample kde-distr) ;; => 3.2761562666387416
...
::: {.sourceClojure}
```clojure
(r/sample empirical-distr) ;; => 0.6697722991704338
(r/sample empirical-distr) ;; => -1.2902499479591785
...
::: {.sourceClojure}
```clojure
(first (r/sequence-generator :sphere 4)) ;; => #vec4 [0.5721472289809604, 0.6458346016564552, 0.32029455950035257, -0.3910966770852592]
...
::: {.sourceClojure}
```clojure
(r/vnoise 0.2) ;; => 0.4541156027546184
(r/vnoise 0.2 0.3) ;; => 0.4463309539411112
(r/vnoise 0.2 0.3 0.4) ;; => 0.4703624166069886
(r/noise 0.2) ;; => 0.47790476190476194
(r/noise 0.2 0.3) ;; => 0.52815025152
(r/noise 0.2 0.3 0.4) ;; => 0.5817763147608519
(r/simplex 0.2) ;; => 0.3599031804342857
(r/simplex 0.2 0.3) ;; => 0.4923554956595277
(r/simplex 0.2 0.3 0.4) ;; => 0.49820142984126986
```
:::
...
::: {.sourceClojure}
```clojure
(some-random-noise 0.2) ;; => 0.650333154475532
(some-random-noise 0.2 0.3) ;; => 0.8520838267329627
(some-random-noise 0.2 0.3 0.4) ;; => 0.6474310491712779
```
:::
...
+ `(billow-noise)`
+ `(billow-noise cfg__15693__auto__)`
...
+ `(ridgedmulti-noise)`
+ `(ridgedmulti-noise cfg__15693__auto__)`
...
+ `(single-noise)`
+ `(single-noise cfg__15693__auto__)`
