...
::: {.printedClojure}
```clojure
#object[org.apache.commons.math3.random.JDKRandomGenerator 0x5879dbbd "org.apache.commons.math3.random.JDKRandomGenerator@5879dbbd"]
...
::: {.sourceClojure}
```clojure
(r/rng :isaac) ;; => #object[org.apache.commons.math3.random.ISAACRandom 0x58023662 "org.apache.commons.math3.random.ISAACRandom@58023662"]
(r/rng :isaac 5336) ;; => #object[org.apache.commons.math3.random.ISAACRandom 0x532513a7 "org.apache.commons.math3.random.ISAACRandom@532513a7"]
(r/synced-rng (r/rng :isaac)) ;; => #object[org.apache.commons.math3.random.SynchronizedRandomGenerator 0x6087f0a2 "org.apache.commons.math3.random.SynchronizedRandomGenerator@6087f0a2"]
```
:::
...
::: {.sourceClojure}
```clojure
(r/irandom my-prng) ;; => 455793813
(r/irandom my-prng 5) ;; => 4
(r/irandom my-prng 10 20) ;; => 18
(r/lrandom my-prng) ;; => -4801330880897268377
(r/lrandom my-prng 5) ;; => 3
(r/lrandom my-prng 10 20) ;; => 16
(r/frandom my-prng) ;; => 0.37822068
(r/frandom my-prng 2.5) ;; => 1.708315
(r/frandom my-prng 10.1 10.11) ;; => 10.102341
(r/drandom my-prng) ;; => 0.9771376741497075
(r/drandom my-prng 2.5) ;; => 1.6717130713680872
(r/drandom my-prng 10.1 10.11) ;; => 10.109029241506125
(r/grandom my-prng) ;; => -0.4694225375340982
(r/grandom my-prng 20.0) ;; => 3.6420378645480804
(r/grandom my-prng 10.0 20.0) ;; => 23.466448297940158
...
::: {.sourceClojure}
```clojure
(take 2 (r/->seq my-prng)) ;; => (0.600355620796756 0.057320206606013)
(r/->seq my-prng 2) ;; => (0.3622763635748505 0.5635874432448933)
(r/->seq my-prng 5 :antithetic) ;; => (0.5553977649185704 0.4446022350814296 0.616418874596327 0.38358112540367295 0.5387231489201532)
(r/->seq my-prng 5 :uniform) ;; => (0.005158601084937208 0.43623586848122625 0.5717294248045643 0.7675736328439515 0.839853138600368)
(r/->seq my-prng 5 :systematic) ;; => (0.1763175783283769 0.3763175783283769 0.5763175783283769 0.7763175783283769 0.976317578328377)
(r/->seq my-prng 5 :stratified) ;; => (0.007068415113182125 0.21098152958340682 0.4871030105883156 0.6644856801096304 0.9263017592905952)
```
:::
...
::: {.printedClojure}
```clojure
#object[org.apache.commons.math3.random.ISAACRandom 0x42c4bc43 "org.apache.commons.math3.random.ISAACRandom@42c4bc43"]
...
::: {.printedClojure}
```clojure
#object[org.apache.commons.math3.random.ISAACRandom 0x4e6c9eaa "org.apache.commons.math3.random.ISAACRandom@4e6c9eaa"]
...
r/default-rng ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x5879dbbd "org.apache.commons.math3.random.JDKRandomGenerator@5879dbbd"]
(r/set-seed) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x6567844f "org.apache.commons.math3.random.JDKRandomGenerator@6567844f"]
(r/set-seed 9988) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x28f26f51 "org.apache.commons.math3.random.JDKRandomGenerator@28f26f51"]
(r/set-seed!) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x5879dbbd "org.apache.commons.math3.random.JDKRandomGenerator@5879dbbd"]
(r/set-seed! 9988) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x5879dbbd "org.apache.commons.math3.random.JDKRandomGenerator@5879dbbd"]
```
:::
...
::: {.sourceClojure}
```clojure
(r/distribution :cauchy) ;; => #object[org.apache.commons.math3.distribution.CauchyDistribution 0x147df25 "org.apache.commons.math3.distribution.CauchyDistribution@147df25"]
(r/distribution :cauchy {:median 2.0, :scale 2.0}) ;; => #object[org.apache.commons.math3.distribution.CauchyDistribution 0x7d4a48f "org.apache.commons.math3.distribution.CauchyDistribution@7d4a48f"]
```
:::
...
::: {.sourceClojure}
```clojure
(r/drandom log-logistic) ;; => 7.445126020973612
(r/frandom log-logistic) ;; => 9.841925
(r/lrandom log-logistic) ;; => 6
(r/irandom log-logistic) ;; => 5
(r/sample log-logistic) ;; => 4.287549930154742
...
::: {.sourceClojure}
```clojure
(r/sample dirichlet) ;; => [0.16731840320109712 0.32766895338648605 0.5050126434124167]
...
(r/log-likelihood dirichlet (repeatedly 10 (fn* [] (r/sample dirichlet)))) ;; => 11.405564692073737
(r/observe dirichlet (repeatedly 10 (fn* [] (r/sample dirichlet)))) ;; => 15.96260929300497
(r/likelihood dirichlet (repeatedly 10 (fn* [] (r/sample dirichlet)))) ;; => 5520991.605152575
...
::: {.sourceClojure}
```clojure
(r/sample weibull) ;; => 0.869239642321827
(r/->seq weibull 3) ;; => (0.8102308387351901 0.7931128156445316 1.321720641084098)
...
(r/set-seed! cauchy-mersenne-2288 2288) ;; => #object[org.apache.commons.math3.distribution.CauchyDistribution 0x4c2f9b79 "org.apache.commons.math3.distribution.CauchyDistribution@4c2f9b79"]
(vec (r/->seq cauchy-mersenne-2288 3)) ;; => [-0.1079136480774541 -5.558982159984645 -3.127061922456471]
```
:::
...
::: {.sourceClojure}
```clojure
(r/->seq r/default-normal 3) ;; => (-1.4945560466761465 0.6512376524678201 0.17361600121538642)
...
::: {.sourceClojure}
```clojure
(r/sample dirichlet3) ;; => [0.3309527202374819 0.3543707664730373 0.31467651328948093]
(r/sample dirichlet3) ;; => [0.118514583877227 0.30728354059644125 0.5742018755263317]
...
::: {.sourceClojure}
```clojure
(r/sample multinomial) ;; => [7 25 39 35 44]
(r/sample multinomial) ;; => [10 20 35 47 38]
...
::: {.sourceClojure}
```clojure
(r/sample mixture-of-three) ;; => 6.446451479453763
(r/sample mixture-of-three) ;; => 0.8783305664229506
...
::: {.sourceClojure}
```clojure
(r/sample truncated-normal) ;; => -1.668045529807081
(r/sample truncated-normal) ;; => 0.6033615843952738
...
::: {.sourceClojure}
```clojure
(r/sample kde-distr) ;; => 1.0501473725887536
(r/sample kde-distr) ;; => 1.8261923863805227
...
::: {.sourceClojure}
```clojure
(r/sample empirical-distr) ;; => 0.9786942429641341
(r/sample empirical-distr) ;; => 0.08577449473784188
...
(map (partial r/icdf cat-distr) [1.0E-4 0.5 0.9999]) ;; => (:b :a nil)
```
:::
...
::: {.sourceClojure}
```clojure
(first (r/sequence-generator :sphere 4)) ;; => #vec4 [-0.33621217692117705, 0.08481821452239983, -0.9365170163526085, 0.0519915440928936]
...
([-0.03117660124400758
  ...
  0.10973009285513022
  0.1130818512395018
  0.012345997091335863
  0.11389671978659667
  0.09416108689583262
  -0.037954536845520845
  0.17748031663776742
  -0.36556378720065175
  0.09544613680434967
  0.14208525256173649
 ...
 [0.061630008116536204
  ...
  -0.33549192629598507
  -0.15604626541645011
  0.045132756050698546
  0.06219470190525861
  0.1833345794350281
  -0.32615920612205385
  -0.6006462298121384
  -0.057459103654643594
  0.14266809921837822
  0.37175518799851043
  0.22825254653469515])
...
::: {.sourceClojure}
```clojure
(r/vnoise 0.2) ;; => 0.39397089420326237
(r/vnoise 0.2 0.3) ;; => 0.4979055200933764
(r/vnoise 0.2 0.3 0.4) ;; => 0.42918210134343593
(r/noise 0.2) ;; => 0.6040314920634922
(r/noise 0.2 0.3) ;; => 0.32783264930539685
(r/noise 0.2 0.3 0.4) ;; => 0.5544648869629758
(r/simplex 0.2) ;; => 0.5566763154285714
(r/simplex 0.2 0.3) ;; => 0.42668336098664733
(r/simplex 0.2 0.3 0.4) ;; => 0.49857798230687833
```
:::
...
::: {.sourceClojure}
```clojure
(some-random-noise 0.2) ;; => 0.5029870750239113
(some-random-noise 0.2 0.3) ;; => 1.0735878092430289
(some-random-noise 0.2 0.3 0.4) ;; => 1.2897653575121655
```
:::
